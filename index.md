...
### Uk labour chatbot:
Built a Streamlit webapp to answer Uk labour law questions , and direct to a specialized from our lawyers bios database
...
The idea behind this project came after scraping 13 years of english football games , as football enthousiasts we wanted to use the learned data mining techniques , to try to:
analyse historical data for a better understanding of the game
create a machine learning model to predict the outcome of this years competition
...
Using NLP , NER(Named entity recognition)  and OCR techniques to detect key elements in invoices . for example the names of the two companies , the prices...
...
### Diabetes Prediction
In a group project that aims on developing a wearable health device , i was in charge to develop an ML model trained on detecting the risk of getting diabetes based on some health indicators
